...
export type SnapRequestParams = {
  ...
  [RPCMethods.EthGetBalance]: [string, string?];
  [RPCMethods.EthGetBlockByHash]: [string, boolean];
  [RPCMethods.EthGetBlockByNumber]: [string, boolean];
  [RPCMethods.EthGetBlockReceipts]: [string];
  [RPCMethods.EthGetBlockTransactionCountByHash]: [string];
  [RPCMethods.EthGetBlockTransactionCountByNumber]: [string];
  [RPCMethods.EthGetCode]: [string, string?];
  [RPCMethods.EthGetFilterChanges]: [string];
  [RPCMethods.EthGetFilterLogs]: [string];
  [RPCMethods.EthGetLogs]: [Filter];
  [RPCMethods.EthGetProof]: [string, string[], string];
  [RPCMethods.EthGetStorageAt]: [string, string, string];
  [RPCMethods.EthGetTransactionByBlockHashAndIndex]: [string, string];
  [RPCMethods.EthGetTransactionByBlockNumberAndIndex]: [string, string];
  [RPCMethods.EthGetTransactionByHash]: [string];
  [RPCMethods.EthGetTransactionCount]: [string, string?];
