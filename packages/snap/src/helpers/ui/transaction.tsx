...
export const buildTxUi = async (
  ...
  const to = (await tx.to) as string;
  ...
  switch (txTypeResult.type) {
    ...
    case TransactionType.simpleSend: {
      ...
      return await snapDialog(DialogType.Confirmation, (
        <Box
          children={[
            ...
            tx.to ? (
              <Box
                children={[
                  <Text children="**To**:" />,
                  <Address
                    address={`0x${normalizeHexadecimalAddress(to)}`}
                  />,
                ]}
              />
            ) : null,
      ...
      return await snapDialog(DialogType.Confirmation, (
        <Box
          children={[
            ...
            <Row
              label="Amount:"
              children={<Text children={formatUnits(amount, decimals)} />}
            />,
          ]}
        />
      ));
