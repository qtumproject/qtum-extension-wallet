    ...
    case TransactionType.simpleSend: {
      ...
      return snap.request({
        ...
        params: {
          ...
          content: (
            <Box>
              <Heading>Sending QTUM</Heading>
              <Row label={formatUnits(value!)}>
                <Image
                  src={
              ...
              {tx.to ? (
                <Box>
                  <Text>**To**:</Text>
                  <Address address={tx.to.toString()}/>
                </Box>
              ) : null}
              <Divider/>
              <Row label="Gas">
                <Text>{formatUnits(tx.gas)}</Text>
              </Row>
              <Divider/>
              <Row label="Total">
                <Text>
                  {formatUnits(Number(tx.gas) + Number(value))}
                </Text>
              </Row>
            </Box>
          ),
    ...
    case TransactionType.tokenMethodApprove:
      return snap.request({
        ...
        params: {
          ...
          content: (
            <Box>
              <Heading>Set a spending cap for your</Heading>
              <Address address={String(tx.to)}/>
              <Divider/>
              <Text>Details</Text>
        ...
        params: {
          ...
          content: (
            <Box>
              ...
              <Row label="Amount:">
                <Text>{formatUnits(amount, decimals)}</Text>
              </Row>
            </Box>
          ),
        },
        ...
        params: {
          ...
          content: (
            <Box>
              ...
              <Divider/>
              <Text>Do you want to send transaction?</Text>
              <Text>{`**Data**: ${tx.data}`}</Text>
            </Box>
          ),
        },
